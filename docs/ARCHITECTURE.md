...
| After unit suites pass | `e2e` | Build Docker images · boot cluster · wait for healthy nodes · run 95 Playwright E2E tests · tear down |
...
- **E2E tests.** In `dashboard/e2e/`. 95 Playwright specs covering the full path from
