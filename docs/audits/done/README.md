...
| [2026-04-15-09](2026-04-15-09.md) | Feature-14 first-pass audit — `job.unschedulable` `reason`-field observer test; 8 items dismissed; pattern-notes load-bearing event payload fields need observer tests |
