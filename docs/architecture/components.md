> **Audience:** engineers
> **Scope:** Coordinator, node agent, runtime interface, analytics pipeline, and ML subsystem internals.
> **Depth:** reference

# Components

Detailed internals for each component of the Helion v2 minimal orchestrator.
For the high-level architecture summary see
[architecture/README.md](README.md); for protocol contracts see
...
[ml-pipelines.md](../guides/ml-pipelines.md) for the user-facing guide.
...
nodes. See [ml-pipelines.md § 9](../guides/ml-pipelines.md#9-security-model--token-scoping-and-attestation).
